...
namespace ns3 {
    ...
    void DRAMCtrl::CycleProcess() {
      //cout<<"In DRAMCtrl::CycleProcess  Fifo ID "<<m_dramBusIfFIFO->m_fifo_id<<endl;
       DRAMCtrlMain();
    ...
    void DRAMCtrl::Step(Ptr<DRAMCtrl> dRAMCtrl) {
      //cout<<"In DRAMCtrl::Step controller ID"<<dRAMCtrl->m_ctrlId<<endl;
